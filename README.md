...
*Evaluation conducted over 10 independent trials per scenario with a control interval of 15 physics steps. "S-NAMO" = our uncertainty-integrated re-implementation.*

| Scenario | S-NAMO\* SR | S-NAMO\* Steps | MAPPO v3 SR | MAPPO v3 Steps | MAPPO v4 SR | MAPPO v4 Steps | Δ vs v3 (SR) | Δ vs S-NAMO\* (SR) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
*\* S-NAMO = S-NAMO + NAMOUnc uncertainty (our enhanced re-implementation, see clarification above). MAPPO v3 suffered entropy collapse at epoch 21. MAPPO v4 is our final optimized model.*
