...
````carousel
![Movable Obstacle Choke NAMO](./results/visualizations/env_movable_obstacle_choke_namo.png)
...
<!-- slide -->
![Warehouse Small](./results/visualizations/env_warehouse_small.png)
### 2. Warehouse Small
...
<!-- slide -->
![Warehouse 3 Robots](./results/visualizations/env_warehouse_3robots.png)
...
<!-- slide -->
![Single Corridor Yielding](./results/visualizations/env_single_corridor_yielding.png)
...
<!-- slide -->
![Symmetric Bottleneck Deadlock](./results/visualizations/env_symmetric_bottleneck_deadlock.png)
...
<!-- slide -->
![Cross Intersection Coordination](./results/visualizations/env_cross_intersection_coordination.png)
...
<!-- slide -->
![Warehouse Large](./results/visualizations/env_warehouse_large.png)
### 7. Warehouse Large
...
<!-- slide -->
![Narrow Doorway Congestion](./results/visualizations/env_narrow_doorway_congestion.png)
...
<!-- slide -->
![Symmetric Bottleneck 4 Robots](./results/visualizations/env_symmetric_bottleneck_4robots.png)
...
<!-- slide -->
![Custom Reconstructed Map](./results/visualizations/env_custom_reconstructed_map.png)
### 10. Custom Reconstructed Map (38 Obstacles)
* **Layout**: High-complexity 20x20 reconstructed warehouse layout.
* **Challenge**: 2 robots (R1, R2) must navigate through a maze with 144 static wall tiles and **38 movable boxes** (obstacles) blocking key passages. Extremely challenging spatial density test.
````
